...
var Mailer = /** @class */ (function () {
    function Mailer() {
        ...
        this.sendMail = function (mailOptions) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.transporter.sendMail(mailOptions)];
                    case 1:
                        result = _a.sent();
        ...
        this._checkEnv(constants_1.envVariablesRequired);
        this.transporter = (0, nodemailer_1.createTransport)(this._getOptions());
    }
    Mailer.prototype._checkEnv = function (variables) {
        var missing = [];
    ...
    Mailer.prototype._getOptions = function () {
        return {
